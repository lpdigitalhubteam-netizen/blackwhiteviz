    ...
    <AnimatePresence>
      {visible && !dismissed ? (
        <motion.aside
          ...
          className="pointer-events-auto fixed right-12 bottom-6 z-[70] w-full max-w-[22rem] rounded-3xl border border-line bg-panel/95 p-6 shadow-2xl backdrop-blur-md sm:max-w-sm sm:p-7 md:max-w-md md:p-8"
